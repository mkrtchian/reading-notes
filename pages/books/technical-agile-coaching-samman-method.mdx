...
- Le coach se comporte comme un visiteur quand il rejoint une équipe qui fonctionne en _ensemble programming_ de manière fluide : il s’insère rapidement et commence à contribuer comme les autres, en suggérant des opportunités de refactoring, de patterns de design etc.
  - **La 1ère étape est donc d’aider l’équipe à fonctionner en tant qu’_ensemble</Book> de manière fluide. C’est là que le coach pourra contribuer le mieux sur l’aspect technique.
...
- Quelques exemples de **situations où un coach Samman peut intervenir** :
  ...
  - Le _typist_ est **la seule personne de l’équipe qui connaît un sujet** et les autres n’arrivent pas à le guider, le coach demande à **quelqu’un d’autre de prendre le rôle de _typist</Book>, pour que l’information circule à travers plusieurs personnes.
